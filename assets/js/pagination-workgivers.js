...
function loadPosts(page) {
    ...
    var apiurl = "/wp-json/wp/v2/onze-werkgever?_embed&per_page=50&filter[orderby]=menu_order&order=asc";
    ...
    $.ajax({
            ...
            for (var p = pageXposts ; p < pageXposts + postsperpage; p++) {
                ...
                if (dataArr[p] && typeof(dataArr[p]) != "undefined" ) {
                    ...
                    html+= `
                        ...
                        <a href="`+ dataArr[p].link+`" class="workgiver-item">
                            <div class="logo">
                                <div>
                            ...
                            <div class="info">
                                <tag> Werkgever </tag>
                                <h4 class="mt16 mb8"> `+ dataArr[p].title.rendered+ `  </h4>
                                <div class="limitRows5 silver">
                                    `+ dataArr[p].excerpt.rendered+ `
                                </div>
                            </div>
                        </a>
        ...
        Pagination.Init(document.getElementById('pagination'), {
            size: Math.ceil(data.length / 8), // pages size
